...
caffevis_caffe_root      = '/mnt/Linux-Extended/DEEP_LEARNING/Yosinski-DeepVis/caffe'

# Load model: caffenet-yos
# Path to caffe deploy prototxt file. Minibatch size should be 1.
caffevis_deploy_prototxt = '%DVT_ROOT%/models/lenet-mnist/lenet.prototxt'

# Path to network weights to load.
caffevis_network_weights = '%DVT_ROOT%/models/lenet-mnist/lenet_iter_1000.caffemodel'

# Other optional settings; see complete documentation for each in settings.py.
#caffevis_data_mean       = '%DVT_ROOT%/models/lenet-minst/ilsvrc_2012_mean.npy'
caffevis_labels          = '%DVT_ROOT%/models/lenet-mnist/mnist_labels.txt'
caffevis_label_layers    = ('ip2', 'prob')
caffevis_prob_layer      = 'prob'
#caffevis_unit_jpg_dir    = '%DVT_ROOT%/models/caffenet-yos/unit_jpg_vis'
caffevis_jpgvis_layers   = ['conv1', 'conv2', 'ip1', 'ip2', 'prob']
...
print("YAVUZ START")
print(caffevis_network_weights)
print("YAVUZ END")
static_files_dir = '/mnt/Linux-Extended/DEEP_LEARNING/Yosinski-DeepVis/deep-visualization-toolbox/models/lenet-mnist/input_images/testSet'
